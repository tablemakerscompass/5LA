...
export const accessibilitySections: LegalSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        list: [
          "Each page has one main heading and a nested heading structure beneath it",
  ...
  },
  {
    ...
    blocks: [
      ...
      "We have not set a fixed deadline for resolving the limitations listed below. We would rather name them honestly than publish a remediation date we cannot commit to. They are recorded and prioritized as part of our ongoing work.",
    ],
  },
  {
    id: "limitations",
    ...
    blocks: [
      "The following issues are known to us from our most recent review. We are listing them because a statement that claimed none would not be accurate.",
      { h3: "Colour contrast of accent text" },
      "The site uses a gold accent colour for small uppercase labels — section eyebrows, article category labels, and similar — and for large decorative numerals. On the site’s cream background, several of these fall below the WCAG AA contrast minimum. This affects small labels on most pages and the oversized decorative numerals on the homepage, About page, and Experience Sectors page. The information these labels carry is always available from the surrounding heading and body text, which meets the contrast minimum. We are reviewing the palette so that accent text meets the minimum as well.",
      { h3: "Reflow at very narrow widths" },
      "At a viewport width of about 320 CSS pixels, a few pages require some horizontal scrolling — the homepage, the About page, the Our Companies page, and the calls to action at the foot of the Insights pages. At typical phone widths the layout adapts without horizontal scrolling.",
      { h3: "Text zoom" },
      "At 200% text size, some pages introduce horizontal scrolling rather than reflowing fully into a single column. Text remains readable and nothing is clipped, but the reading experience at that zoom level is not what it should be.",
      { h3: "Heading order" },
      "The Our Companies listing page moves from the page heading to third-level headings without an intervening second-level heading. Screen-reader users navigating by heading level may find that ordering unexpected.",
      { h3: "Target size" },
      "Some navigation and footer links have a clickable area shorter than the 24-by-24 pixel minimum introduced in WCAG 2.2. The links are spaced apart rather than crowded together, but the targets are smaller than they should be.",
      { h3: "Testing coverage" },
      "Our review combined automated checks with manual keyboard testing in a single browser. We have not carried out formal testing with screen readers, magnification software, voice-control software, or switch devices, and we have not commissioned an independent audit. There may be barriers we have not found.",
