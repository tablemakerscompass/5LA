...
import styles from "./VxAgencyOutcomes.module.css";
...
export default function VxAgencyOutcomes() {
  return (
    <section
      className={`section ${styles.wrap}`}
      data-surface="dark"
      aria-labelledby="agency-outcomes-heading"
    >
      <Container>
        <Reveal className={styles.head}>
          <p className="eyebrow">The Result of a 5LA Engagement</p>
          <hr className={`rule ${styles.rule}`} />
          <h2 id="agency-outcomes-heading" className={`section-heading ${styles.heading}`}>
